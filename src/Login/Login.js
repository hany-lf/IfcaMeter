...
//   }
  ...
  signIn = async (res) => {
    ...
    try {
      _storeData("@DashMenu", res.Data.DashMenu);
      ...
      _storeData("@Handphone", res.Data.handphone);
      _storeData("@isLogin", this.state.isLogin);
      _storeData("@isReset", res.Data.isResetPass);
      _storeData("@AgentCd", res.Data.AgentCd);
      _storeData("@Debtor", res.Data.Debtor_acct);
      _storeData("@rowID", res.Data.rowID);
      _storeData("@RefreshProfile", false);
      _storeData("@UserProject", res.Data.UserProject);
      _storeData("@AttendanceSession", res.Data.AttendanceSession);
      _storeData('@SaveDataMeter', "[]");
    } catch (err) {
  ...
  _renderNextButton = () => {
    return (
      <View>
        <Text style={styles.title_next}>Next</Text>
      </View>
    );
  };
  _renderSkipButton = () => {
  ...
  _renderDoneButton = () => {
    return (
      <View>
        <Text style={styles.title_done}>Done</Text>
      </View>
    );
  };
...
const slides = [
  {
    key: "s1",
    text: "Find information and update Engineering",
    title: "Get Info Engineering",
    titleStyle: styles.title_urban,
    textStyle: styles.text_urban,
    image: require("@Asset/images/walktrough/logoengineer.png"),
  ...
  {
    key: "s2",
    title: "See Meter Reading",
    titleStyle: styles.title_urban,
    textStyle: styles.text_urban,
    text: "Get detailed info about your currently meter reading",
  ...
  },
  {
    ...
    titleStyle: styles.title_urban,
    textStyle: styles.text_urban,
    text: "Customer service are more practical via online",
  ...
  },
  {
    ...
    titleStyle: styles.title_urban,
    textStyle: styles.text_urban,
    text: "Your asset easily to maintenance from here",
    // image: {
    //     uri:
