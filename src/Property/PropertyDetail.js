...
getAmenities = (item) => {
  {isMount ?
  fetch(urlApi+'c_reservation/getAmenities/'+item.db_profile+'/'+item.entity_cd+'/'+item.project_no,{
      method:'GET',
      headers : this.state.hd,
  }).then((response) => response.json())
  .then((res)=>{
        ...
        <View style={Styles.count}>
                  ...
                  <List style={Styles.infoTab}>
                    <View style={Styles.overview}>
                      {/* <Text style={Styles.overviewTitle}>Infrastructure</Text> */}
                        ...
                        //   {feature}
                        // </Text>
                        <HTML html={this.state.dataAmenities.infrastructure[0].amenities_info} imagesMaxWidth={Dimensions.get('window').width} />
                        :<ActivityIndicator /> }
                    </View>
                  </List>
              </Tab>
                ...
                <List style={Styles.infoTab}>
                  <View style={Styles.overview}>
                    {/* <Text style={Styles.overviewTitle}>School</Text> */}
                      ...
                      //   {feature}
                      // </Text>
                      <HTML html={this.state.dataAmenities.school[0].amenities_info} imagesMaxWidth={Dimensions.get('window').width} />
                      :<ActivityIndicator /> }
                  </View>
                </List>
              </Tab>
                ...
                <List style={Styles.infoTab}>
                  <View style={Styles.overview}>
                    {/* <Text style={Styles.overviewTitle}>Infrastructure</Text> */}
                      ...
                      //   {feature}
                      // </Text>
                      <HTML html={this.state.dataAmenities.hospital[0].amenities_info} imagesMaxWidth={Dimensions.get('window').width} />
                      :<ActivityIndicator /> }
                  </View>
                </List>
              </Tab>
                ...
                <List style={Styles.infoTab}>
                  <View style={Styles.overview}>
                    {/* <Text style={Styles.overviewTitle}>Infrastructure</Text> */}
                      ...
                      //   {feature}
                      // </Text>
                      <HTML html={this.state.dataAmenities.other[0].amenities_info} imagesMaxWidth={Dimensions.get('window').width} />
                      :<ActivityIndicator /> }
                  </View>
                </List>
              </Tab>
          ...
          <View style={Styles.overview_location}>
            <Text style={Styles.overviewTitle_youtube}>Location</Text>
              ...
              <TouchableOpacity  onPress={() => Linking.openURL(this.state.project[0].direction_map)}>  
                <WebView
